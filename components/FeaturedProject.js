    ...
    <div>
      {featured.map(
        ({ name, description, repo_link, live_link, project_img, tech }) => (
          ...
          >
            <div className='absolute opacity-[10%] w-full max-w-xl h-full right-0 bottom-0 md:h-auto md:w-[40vw] md:bottom-0 z-[-1] cursor-pointer md:hover:filter md:brightness-50 md:group-hover:opacity-80 md:group-hover:origin-bottom-right md:group-hover:scale-110 transition-all duration-500'>
              <img
