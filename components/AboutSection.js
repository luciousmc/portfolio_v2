    ...
    <div className='flex flex-col lg:flex-row sm:px-5'>
      ...
      <div className='space-y-4 text-justify pl-10 text-xl font-light'>
        ...
        <p>
          ...
          thing. My curious little mind had stumbled upon the words, &quot;Build
        ...
        <p>
          ...
          legendary anime &quot;Dragon Ball Z&quot;. In high school I made a
          site with a friend that featured the funniest content we could find
          around the internet. By this time, CSS had made its appearence so no
          more styling within the tags themselves.
        </p>
        <p>
          ...
          doing. Shortly after, I enrolled in LearningFuze&apos;s Web
          Development program and dove head first. It was the most challenging
          and rewarding experience I&apos;ve had. I learned various technologies
          and programming languages such as Javascript, jQuery, Node.js, PHP,
          MySQL, React and Postgres just to name a few. We were put in teams and
          completed a few 3 day hackathons and a 3 week final project. Working
          in those teams taught me so much. I loved every minute of it. Going
          through the AGILE and SCRUM processes really gave our team direction
          and unity.
        </p>
        <p>
          I&apos;m looking forward to further my depth of knowledge of
          programming and the vast possibilities that it offers. Creating new
          things and improving on others.
        </p>
      </div>
    </div>
  );
